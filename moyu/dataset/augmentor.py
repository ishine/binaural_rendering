...
from moyu.utils.calculate import db_to_magnitude, get_pitch_shift_factor, magnitude_to_db
...
class Augmentor:
    ...
    def __call__(self, waveform: np.ndarray, source_type: str) -> np.ndarray:
    ...
    def pitch_shift(self, waveform: np.ndarray, source_type: str) -> np.ndarray:
    ...
    def magnitude_scale(self, waveform: np.ndarray, source_type: str) -> np.ndarray:
    ...
    def swap_channel(self, waveform: np.ndarray, source_type: str) -> np.ndarray:
    ...
    def flip_axis(self, waveform: np.ndarray, source_type: str) -> np.ndarray:
